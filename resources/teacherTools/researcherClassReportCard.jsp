...
<!-- Frank 01-08-22  	Issue #578 added anonymous option to 2 reports, removed 'fixed column' params for reports using paging option -->
...
var headers2 = changeLandingPageHeader2AccordingToLanguage();
	...
	if (landingPageReport2) {
		landingPageReport2.destroy();
	    $('#landingPageReport2').empty();
	}    
	if (languageSet == 'es') {
...
//                    },                   
    ...
    $('#showLandingReportTwoBtn').on('click', function ()  {
