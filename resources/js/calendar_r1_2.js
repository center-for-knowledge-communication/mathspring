function generate_year_range(start, end) {
  ...
  for (var year = start; year <= end; year++) {
      years_r1_cal2 += "<option value='" + year + "'>" + year + "</option>";
  }
  return years_r1_cal2;
}
...
var createYear_r1_cal2 = generate_year_range(2020, 2022);
/** or
* createYear = generate_year_range( 1970, currentYear );
*/

document.getElementById("year_r1_cal2").innerHTML = createYear_r1_cal2;
