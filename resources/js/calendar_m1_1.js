function generate_year_range(start, end) {
  ...
  for (var year = start; year <= end; year++) {
      years_m1_cal1 += "<option value='" + year + "'>" + year + "</option>";
  }
  return years_m1_cal1;
}
...
var createYear_m1_cal1 = generate_year_range(2020, 2022);
/** or
* createYear = generate_year_range( 1970, currentYear );
*/

document.getElementById("year_m1_cal1").innerHTML = createYear_m1_cal1;
