...
try {
	...
	if (strExperiment.indexOf("multi-lingual") < 0) {
		...
		submit_answer = rb.getString("submit_answer");
		example_problem_play_hints = rb.getString("example_problem_play_hints");
		
		
		alt_step_by_step_solution = rb.getString("step_by_step_solution");
		alt_submit_answer = rb.getString("submit_answer");
		alt_example_problem_play_hints = rb.getString("example_problem_play_hints");
