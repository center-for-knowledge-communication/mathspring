 ...
 * For more info on table sorter see: http://www.javascripttoolbox.com/lib/table/index.php
      ...
      sort.numeric_converter = function(separator) {
		return function(val) {
			if (typeof(val)=="string") {
				// if it has a - sign then the regular expressions lose it and I have to convert the number to negative manually
				var factor = (val.indexOf("-") == -1) ? 1 : -1;
