...
<OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
    ...
    <PARAM NAME=movie VALUE="../wayang2/flash/client/wayang_loader.swf?ip=<% out.print(request.getParameter("ipAddr")); %>">
    <PARAM NAME=quality VALUE=best> <PARAM NAME=bgcolor VALUE=#9E6B6B>
    <EMBED base="." src="../flash/wayang_loader.swf?ip=<% out.print(request.getParameter("ipAddr")); %>"
