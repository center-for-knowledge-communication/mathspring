...
public class StudentModelMotivational extends AffectStudentModel {
    private static Logger logger = Logger.getLogger(StudentModelMotivational.class);

    private static final String STUD_FNAME = "sm.fname";
    static final int GENDER_PROP_ID = 3;
    public static final int INCOMPLETE_HISTORY = -1;
    private static final String RECENTATTEMPT_NOHINT = "sm.RecentAttemptsNoHint";
    private static final String RECENTATTEMPT_HINT = "sm.RecentAttemptsHint";
    private static final String PREVIOUS_ATTEMPT_NOHINT = "sm.PreviousAttemptsNoHint";

    private static final String FIRSTATTEMPT_NOHINT = "sm.FirstAttemptsNoHint";
    private static final String FIRSTATTEMPT_HINT = "sm.FirstAttemptsHint";
    private static final String NUM_PROBS_SOLVED = "sm.numProbsSolved";
    private static final String MOTIVATED = "sm.motivated";
    private static final String SELF_CONFIDENT = "sm.self-confident";
    ...
    public static final String avgAttemptsInAssistedProblem_SQL = "sm.inchp_ct";
    public static final String avgTimeInProblem_ms_SQL = "sm.secsp_ct";
    public static final String Serious_SQL = "sm.ser_cat";
    public static final String gender_SQL = "sm.gender"; // zero is male, 1 is female
    public static final String avgTimeBetweenAttempts_SQL = "sm.tmbet_ct"; // milliseconds
    public static final String avgHintsGivenPerProb_SQL = "sm.avgh_ct";
    public static final String avgHintsGivenPerAssistedProb_SQL = "sm.avghtshp";
    public static final String perc_helpedProblems_SQL = "sm.pc_hp_ct";
    public static final String perc_hintsAfterSolve_SQL = "sm.p_afc_ct";
    public static final String avgAttemptsInProb_SQL = "sm.incap_ct";
    public static final String pretestNumCorrect_SQL = "sm.preco_ct";
    public static final String pretestNumIncorrect_SQL = "sm.pr_in_ct";
    public static final String perc_hintsBeforeAttempt_SQL = "sm.p_hba_ct";
    public static final String avgTimeInAssistedProblem_ms_SQL = "sm.scshp_ct"; //milliseconds
    public static final String ChallengeAttitude_SQL = "sm.challeng";
    public static final String OtherApproachesAttitude_SQL = "sm.otherapp";
    public static final String NotCareHelpAttitude_SQL = "sm.nocareh";
    public static final String GetOverWithAttitude_SQL = "sm.fast";
    public static final String LearnedPerception_SQL = "sm.lrn_cat";
    public static final String HelpfulPerception_SQL = "sm.hlp_cat";
    public static final String ReturnPerception_SQL = "sm.ret_cat";
    public static final String LikedPerception_SQL = "sm.lik_cat";
    public static final String LearningEstimation_SQL = "sm.g_cor_ct";
    public static final String FearOfWrong_SQL = "sm.nowrong";
...
// The medians of the predictions
/*
  ...
  public static final double NotCareHelpAttitude_Threshold = 0.1739;                                la
...
// 13 Behavioral Variables
    ...
    public StudentModelMotivational(Connection conn) throws SQLException {
        super(conn);
    }
...
//        numProbsSolved = getPropInt(this.objid, NUM_PROBS_SOLVED, 0);
        ...
        RecentProbs_FirstAttempt_NoHint = new Vector();
...
// Still have to load the WithPossibleHint
    ...
    public void studentAttempt(StudentState state, String answer,
        ...
        /*  UPDATE THE QUEUE FOR THE CORRECTNESS OF THE LAST PROBLEMS SOLVED*/
...
// Doesn't matter if hints were seen or not, because the problem was solved incorrectly
    ...
    public boolean save() throws SQLException {
        ...
        setProp(this.objid, MOTIVATED, java.lang.Math.random() > .5 ? true : false);
        setProp(this.objid, SELF_CONFIDENT, java.lang.Math.random() > .5 ? true : false);
