 ...
 */
public class ShowVideoIntervention extends ChangeGUIIntervention implements AttemptIntervention {


    public ShowVideoIntervention(String when, String dialogHTML, boolean notify, String component, String action) {
        super(when, dialogHTML, notify, component, action);
    }

    public String getType () {
        return "ShowVideoIntervention";
    }
