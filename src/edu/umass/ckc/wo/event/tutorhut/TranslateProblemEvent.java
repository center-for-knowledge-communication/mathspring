 ...
 */
public class TranslateProblemEvent extends IntraProblemEvent {
    // for debugging
...
*/        
    ...
    public TranslateProblemEvent (long elapsedTime, long probElapsedTime) {
        this.probElapsedTime = probElapsedTime;
        this.elapsedTime = elapsedTime;
    }

    public TranslateProblemEvent (long elapsedTime, long probElapsedTime, Lesson l) {
        this.probElapsedTime = probElapsedTime;
        this.elapsedTime = elapsedTime;
        this.lesson = l;
    }

    public TranslateProblemEvent (long elapsedTime, long probElapsedTime, String probId) {
        this(elapsedTime,probElapsedTime);
        this.probId = probId;
    }

    public TranslateProblemEvent (long elapsedTime, long probElapsedTime, int topicToForce) {
        this(elapsedTime,probElapsedTime);
    ...
    public TranslateProblemEvent(long elapsedTime, long probElapsedTime, String probId, String probMode) {
